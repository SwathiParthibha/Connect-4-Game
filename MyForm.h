...
namespace Connect4 {
	...
	private:
		...
		List<int>^ col1 = gcnew List<int>();
		List<int>^ col2 = gcnew List<int>();
		List<int>^ col3 = gcnew List<int>();
		List<int>^ col4 = gcnew List<int>();
		List<int>^ col5 = gcnew List<int>();
		List<int>^ col6 = gcnew List<int>();
		List<int>^ col7 = gcnew List<int>();
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->clear->Font = (gcnew System::Drawing::Font(L"Tahoma", 10.125F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
